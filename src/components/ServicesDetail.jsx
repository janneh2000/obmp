...
const FALLBACK_SERVICES = [
  ...
  },
  {
    ...
    description:
      "Our E&P division leverages advanced seismic data analysis, modern drilling technologies, and seasoned geological expertise to identify and develop hydrocarbon resources across African basins. We operate with world-class HSE standards and strong government partnerships.",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "OBMP's trading division executes sophisticated petroleum commodity transactions connecting African buyers and sellers to international markets. Our experienced trading desk provides price risk management, supply optimization, and procurement strategies that maximize value.",
    capabilities: [
